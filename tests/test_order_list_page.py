...
class TestOrderList:
    ...
    def test_click_order_card(self, driver_both):
        test_order_list = OrderList(driver_both)
        test_order_list.click_order_list()
        test_order_list.wait_and_find_order_card()
        test_order_list.click_order_card()
        name = test_order_list.wait_and_find_order_card_window()
    ...
    def test_make_order_and_check_order_list(self, default_user, driver_both):
        ...
        test_order_list = OrderList(driver_both)
        test_order_list.click_button_account()
        test_order_list.set_email_input(email)
        test_order_list.set_password_input(password)
        test_order_list.finish_login_make_order_close_window()
        test_order_list.enter_account_enter_profile_history()
        number_profile = test_order_list.number_text()
        test_order_list.click_order_list_and_wait_left_block()
        number_list = test_order_list.block_text()
    ...
    def test_counter_total_changes(self, default_user, driver_both):
        ...
        password = default_user["password"]
        test_order_list = OrderList(driver_both)
        test_order_list.click_order_list_and_find_block_total()
        old_data = test_order_list.block_total_text()
        test_order_list.click_button_account()
        test_order_list.set_email_input(email)
        test_order_list.set_password_input(password)
        test_order_list.finish_login_make_order_close_window()
        test_order_list.click_order_list_and_find_block_total()
        new_data = test_order_list.block_total_text()
    ...
    def test_counter_daily_changes(self, default_user, driver_both):
        ...
        password = default_user["password"]
        test_order_list = OrderList(driver_both)
        test_order_list.click_order_list_find_block_daily()
        old_data = test_order_list.block_daily_text()
        test_order_list.click_button_account()
        test_order_list.set_email_input(email)
        test_order_list.set_password_input(password)
        test_order_list.finish_login_make_order_close_window()
        test_order_list.click_order_list_find_block_daily()
        new_data = test_order_list.block_daily_text()
        assert int(new_data) > int(old_data)
    ...
    def test_make_order_and_check_order_in_work(self, default_user, driver_both):
        ...
        test_order_list.enter_account_enter_profile_history()
        number_profile = test_order_list.number_text()
        test_order_list.click_order_list_find_in_work()
        number_in_work = test_order_list.number_in_work_text()
